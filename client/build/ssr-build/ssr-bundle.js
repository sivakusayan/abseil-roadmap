...
/* harmony import */ var _styles_index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("iOjB");
/* harmony import */ var _components_PostListBox__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("TToB");
...
function App() {
  return h(_components_PostListBox__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"], null);
}
...
function PostListBox() {
  ...
  Object(preact_hooks__WEBPACK_IMPORTED_MODULE_0__[/* useEffect */ "a"])(function () {
    fetch("/api/posts?fields=id,title_html").then(function (res) {
      return res.json();
    }).then(function (posts) {
      return setPosts(posts);
    });
  }, []);
  return h("ul", null, !posts ? "Loading..." : posts.map(function (post) {
    return h("li", {
